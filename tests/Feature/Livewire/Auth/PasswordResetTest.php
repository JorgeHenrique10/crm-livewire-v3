...
test('checking form roles', function ($field, $value, $rule) {
    Notification::fake();
    ...
    'email:confirmed'    => ['field' => 'email', 'value' => 'email@email.com', 'rule' => 'email_confirmed'],
    'email:email'        => ['field' => 'email', 'value' => '', 'rule' => 'email'],
